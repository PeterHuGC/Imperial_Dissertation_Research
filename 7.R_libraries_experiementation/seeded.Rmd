...
Doesn't seem to run too slowly, so perhaps it could work on job descriptions
...
**This is about addding unseeded topics in addition to seeded topics**

Everything is based on the yaml file.
