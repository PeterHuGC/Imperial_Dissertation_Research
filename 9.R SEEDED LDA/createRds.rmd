...
corpus <- corpus(data_abbreviated$document)
...
```{r}
write.csv(data_abbreviated, "data/boardex_director_employment_data_comp_net_2011_2023_without_blank_job_descriptions.csv")
```
